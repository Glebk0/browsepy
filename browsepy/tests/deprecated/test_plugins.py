...
class TestPlugins(unittest.TestCase):
    ...
    def test_manager(self):
        ...
        self.assertEqual(
            self.app.view_functions["old_test_plugin.root"](), "old_test_plugin"
        )
...
class TestPlayer(TestPlayerBase):
    def test_register_plugin(self):
        ...
        self.assertIn(
            self.module.detect_playable_mimetype, self.manager.mimetype_functions
        )
...
class TestIntegration(TestIntegrationBase):
    ...
    def test_for_file(self):
        ...
        manager.register_action("browse", widget, mimetypes=("*/plain",))
        file = self.file_module.File("asdf.txt", plugin_manager=manager, app=self.app)
